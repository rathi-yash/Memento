...
**Memento** is an innovative application designed to assist dementia patients in improving their quality of life and maintaining stronger connections with their caregivers and family members. The app leverages advanced technologies, including OpenCV, DeepFace, speech recognition, and geolocation tracking, to offer features such as recognition of close relations, conversation recording, medication reminders, and location tracking for safety. Additionally, it helps doctors by collecting valuable data for diagnosis.

## Key Features

### 1. **Facial Recognition for Close Relations**
   - Using **OpenCV** and **DeepFace**, Memento recognizes faces of family members and close relations. When a patient encounters a familiar face, the app identifies the person and provides relevant information, including their name and details about previous conversations.
...
### 3. **Location Tracking and Caregiver Notifications**
   - Memento tracks the patient's **geolocation** to ensure their safety.
...
### 4. **Data Collection for Doctors**
   - Memento collects crucial data during interactions and daily activities. This data is stored securely and can be shared with doctors to assist in diagnosing and monitoring the patient's condition.
...
### **Speech Recognition and Reminders:**
   - The app listens to the patient's voice and captures audio. Using advanced **speech recognition** algorithms, Memento transcribes the conversation into text and stores it.
...
### **Location Tracking:**
   - Memento uses **GPS tracking** to monitor the patient's location in real-time.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/yourusername/Memento-backend.git
   cd Memento-backend
   ```
...
Memento takes the privacy and security of the patient's data very seriously:
...
- **Enhanced AI**: Future versions of Memento may include more advanced AI models to improve recognition and better understand the patient's emotional state.
...
We welcome contributions to **Memento**. If you'd like to contribute, please fork the repository and submit a pull request. For any issues or feature requests, please create an issue in the GitHub repository.
...
Thank you for using **Memento**! We hope it can make a difference in the lives of dementia patients and their caregivers.
