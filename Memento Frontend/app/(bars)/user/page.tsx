        ...
        <>
                ...
                <div className="bg-white border-b border-gray-200 mb-6 px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            ...
                            size="lg"
                        >
                            <PlusIcon className="mr-2 w-5 h-5" /> Add Relation
                        </Button>
                    </div>
                </div>
                    ...
                    {filteredRelations.length === 0 ? (
                        <Card className="bg-white border-gray-200">
                            <CardContent className="flex flex-col items-center justify-center py-20">
                                ...
                                <h3 className="text-2xl font-semibold text-gray-900 mb-2">No relations yet</h3>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-md bg-white">
                    <DialogHeader>
                        <DialogTitle className="text-2xl text-gray-900">Add New Relation</DialogTitle>
                    </DialogHeader>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="flex flex-col items-center gap-4">
                            <div className="relative">
                                <label htmlFor="img-input">
                                    <Avatar className="h-24 w-24 cursor-pointer border-2 border-purple-600">
                                        {previewUrl ? (
                                            <AvatarImage
                                                src={previewUrl}
                                                alt="Preview"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="relationship" className="text-gray-900">Relationship</Label>
                            <Input
                                id="relationship"
